...
const StainlessSteel304LFlanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            MANUFACTURER OF ASTM A182 F304L LAP JOINT FLANGES, 304L SS LONG WELD NECK FLANGES, STAINLESS STEEL 304L SORF FLANGES, SS 304L THREADED FLANGES, READY STOCK OF SS 304L FLANGES SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a known stockist and exporter of SS 304L Flanges, a versatile metal used in the fabrication of dual joints by brazing, soldering, or welding. Stainless Steel UNS S30403 Reducing Flanges are pressure-maintenance flanges with one solid end and one open end joined by a web or tie-bar. The open end forms closures that allow for normal flow through the pipe work. Non-consumable electrodes are sometimes used, but because they are not heated by the welding process, they are usually prohibited. These flanges undergo various forming processes such as punching, slotting, machining, knurling, cutting, and drilling, and are available in a wide range of grades and sizes.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 304L Flanges Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">SS 304L Flanges Equivalent Grades</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        </div><br />       <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 304L Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr  className="bg-primary text-white">
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">304L Stainless Steel Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr  className="bg-primary text-white">
                        ...
                        </div><br />  <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Stainless Steel 304L Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default StainlessSteel304LFlanges