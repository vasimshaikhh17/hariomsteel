...
const AlloySteelA182F12Flanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Ready Stock Of Chrome Moly F12 Flanges, Alloy Steel F12 Threaded Flanges, Alloy Steel F12 SORF Flanges, Manufacturer of ASTM A182 Cr-Mo F12 Lap Joint Flanges, CrMo F12 Long Weld Neck Flanges.        </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is supplier & manufacturer of AS ASTM A182 F12 Flanges, which are available in both tailored and regular sizes. These and other corrosion-resistant metals have long been used in the power production sector to combat corrosion, particularly at high temperatures. The processing, pharmaceutical, and oil & gas sectors, which have established an enormous market for pipelines, pumps, valves, and stainless tanks, are most likely the most demanding industries that use these Alloy Steel ASME SA182 F12 Puddle Flanges. The most well-known utilisation of this steel is most likely for kitchenware and utensils. They are used in a variety of industries, including fuel, chemical, aircraft, electricity, papermaking, boiler heat exchangers, and so on. They are highly diverse due to the use of sophisticated technology.            </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F12 Flanges Specifications</h2>
                                ...
                                <h2>Alloy Steel F12 Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                       <tbody>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F12 Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr className="bg-primary text-white">
                        <td rowSpan="2"><strong>Grade</strong></td>
                        <td rowSpan="2"><strong>Tensile Strength (Mpa)</strong></td>
                        <td rowSpan="2"><strong>Yield Strength (Mpa)</strong></td>
                        <td rowSpan="2"><strong>Elongation %</strong></td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel F12 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default AlloySteelA182F12Flanges
