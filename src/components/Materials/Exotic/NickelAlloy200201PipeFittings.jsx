...
import nickelalloy from "../../../assets/newImages/nickel-alloy-200-fitting.jfif"

const NickelAlloy200201PipeFittings = () => {
  return (
    <div>
      <Layout>
        <div>
            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  201 Nickel LR Elbow, Nickel 200 Elbow, Ready Stock Of Alloy
                  201 Pipe Fittings, Manufacturer of ASTM B366 Nickel Alloy 200
                  Pipe Elbow, Nickel Alloy 200 Buttweld Fittings Supplier
                </h1>
                ...
                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Nickel UNS N02200 Elbow Pipe Fittings are a solution-heated
                    (2100° F / 1150° C), controlled-carbon alloy with better
                    elevated temperature characteristics. Extruded pipes for
                    ethylene and steam methane reforming furnaces, as well as
                    ammonia effluent refrigerators, are also made from this
                    steel. It is resistant to salt stress-corrosion fracture.
                    Nickel WNR 2.4066 Tee Pipe Fittings have better creep and
                    stress-rupture properties in the temperature range of 1100
                    degrees Fahrenheit (593 degrees Celsius) to 1800 degrees
                    Fahrenheit (982 degrees Celsius). It was modified to
                    maximise tension rupture characteristics by controlling
                    carbon and particle size.
                  </p>

                  <div className="mt-5 mb-5  flex items-center justify-center">
                    <img src={nickelalloy} alt="" width={500} />
                  </div>

                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Nickel Alloy 200/201 Pipe Fittings Specifications
                  </h2>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Nickel 200/201 Butt weld Fittings Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    200/201 Nickel Pipe Fittings Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Nickel Alloy 200/201 Pipe Fittings Thickness Chart
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default NickelAlloy200201PipeFittings;
