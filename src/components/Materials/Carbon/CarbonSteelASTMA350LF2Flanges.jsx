...
const CarbonSteelASTMA350LF2Flanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            MANUFACTURER OF A350 LF2 LAP JOINT FLANGES, ASTM A350 LF2 LONG WELD NECK FLANGES, CARBON STEEL ASTM A350 LF2 SORF FLANGES, READY STOCK OF CS A350 LF2 FLANGES, CARBON STEEL ASTM A350 LF2 THREADED FLANGES SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a supplier of CS ASTM A350 LF2 Flanges, widely used in various construction sectors and renowned for their high quality. Carbon Steel ASME SA350 LF2 Blind Flanges are specifically designed for use in pipeline systems within the chemical, oil, gas, food processing, and petrochemical industries. Developed by our skilled experts, these flanges undergo rigorous quality testing to ensure flawless construction and reliable performance. As a leading company, we manufacture, supply, and trade high-quality steel with features such as corrosion resistance, durability, and heat resistance. Our products offer numerous benefits, including rust resistance, dependable performance, accurate dimensions, high efficiency, economical construction, long useful life, sturdy construction, and robust design.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Carbon Steel ASTM A350 LF2 Flanges Specifications</h2>
                ...
                {/* weight chart */}
                {/* dimensionchart */}
               <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Carbon Steel ASTM A350 LF2 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default CarbonSteelASTMA350LF2Flanges