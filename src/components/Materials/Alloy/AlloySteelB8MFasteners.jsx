      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Ready Stock Of Cr-Mo Gr. B8M Allen Cap Bolt, Alloy Steel B8M Socket Head Cap Screw, Manufacturer of Chrome Moly B8M Threaded Rod, B8M Alloy Steel High Temperature Fasteners, Alloy Steel B8M Hex Bolt         </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a well-known supplier of AS B8M Fasteners, which are accessible to our esteemed customers in customised sizes and forms.    </p>
              <p className="mb-2 text-justify">
              Alloy Steel B8M Nuts is typically provided in the solution-treated state, following a treatment at 2150 degrees Fahrenheit (1175 degrees Celsius) and fast cooling. It will be made at 2200 degrees Fahrenheit / 1600 degrees Fahrenheit (1205 degrees Celsius / 870 degrees Celsius). However, light forging in these products may be performed at temperatures below 1200° F (650° C) to enhance mechanical characteristics. It is also rust resistant, heat resistant, and oxidation resistant, able to endure reducing or neutral atmospheres as well as oxidation. It's also used in the chemical industry for retorts, muffles, catalyst support grids, furnace baffles, pyrolysis ducting, and flash dryer components.
              </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B8M Fasteners Specifications</h2>
                                <div className="overflow-x-auto">
                                <table>
                                <tbody>
                                <tr>
                                <th>Specification</th>
                                <td>ASTM A193 / ASME SA193</td>
                                </tr>
                                <tr>
                                <th>Dimensions</th>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B8M Fasteners Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody><tr><td><strong>Grade</strong></td><td><strong>C</strong></td><td><strong>Mn</strong></td><td><strong>P</strong></td><td><strong>S</strong></td><td><strong>Si</strong></td><td><strong>Cr</strong></td><td><strong>Ni</strong></td><td><strong>Mo</strong></td></tr><tr><td><strong>B8M</strong></td><td>0.08% max</td><td>2.00% max</td><td>0.045%</td><td>0.030%</td><td>1.00% max</td><td>16.0 - 18.0%</td><td>10.0 - 14.0%</td><td>2.00 - 3.00%</td></tr></tbody>
                        </table>
                        </div><br></br>

                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B8M Fasteners Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody><tr><td><strong>Grade</strong></td><td><strong>Tensile Strength (MPa) min</strong></td><td><strong>Yield Strength 0.2% Proof (MPa) min</strong></td><td><strong>Elongation (% in 50mm) min</strong></td><td><strong>RA % min</strong></td></tr><tr><td><strong>Alloy Steel B8M Class 1</strong></td><td>75</td><td>30</td><td>30</td><td>50</td></tr><tr><td><strong>Alloy Steel B8M Class 2</strong></td><td>110</td><td>95</td><td>15</td><td>45</td></tr></tbody>
                        </table>
                        </div><br />

                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel B8M Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
                <thead>
                <tr>
            ...
            <h2 className="mb-4 mt-4 font-bold text-2xl">Dimensions Of Alloy Steel B8M Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
            <thead>
              <tr>
...
export default AlloySteelB8MFasteners
