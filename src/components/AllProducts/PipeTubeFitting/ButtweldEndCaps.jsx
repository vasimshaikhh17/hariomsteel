                    ...
                    <div className="customContainer text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
                        <div className="lg:w-3/4 lg:pr-6">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="mb-2">
                                    Buttweld End Caps are essential components used in piping systems to close the ends of pipes and tubes. These caps are welded onto the end of the pipe, providing a secure and leak-proof seal. They are commonly used in industries such as oil and gas, chemical processing, and power generation due to their strength and durability.
                                </p>
                                <p className="mb-2">
                                    These fittings ensure the safety and integrity of the piping system by preventing the escape of fluids and gases.
                                </p>
                                <ul className="list-disc list-inside">
                                    <li>Secure and leak-proof seal</li>
                            ...
                            <div className="mt-8">
                                <h2 className="text-2xl font-semibold text-gray-800 mb-4">
                                    Buttweld End Caps Characteristics
                                </h2>
                            ...
                            <div className="mb-6">
                                <h2 className="text-xl font-semibold mb-2 mt-4">
                                    Buttweld End Caps Specifications
                                </h2>
                                <ul className="list-disc list-inside">
                                    <li>
...
export default ButtweldEndCaps;
