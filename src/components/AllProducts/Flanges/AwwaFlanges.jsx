...
import awwaFlanges from "../../../assets/newImages/awwaflanges.jpg";
          ...
          <div className="text-fontDefault p-4 prod">
            <div className="customContainer text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-6">
                ...
                <div className="mb-6">
                  <p className="mb-2">
                  Hariom Steels is a supplier of AWWA Pipe Flanges, made from low carbon high alloy austenitic steel, which is extensively used in applications where rust resistance is essential. Stainless Steel AWWA Flanges can be cold- and hot-formed, but they can only be hardened through cold working, making them challenging to process and prone to work hardening. This product features a mix of chromium and molybdenum, providing enhanced resistance to pitting and crevice corrosion caused by chlorides. It also offers exceptional resilience to stress corrosion cracking compared to other steel types. AWWA Pipe Flanges have a significantly higher rate of thermal expansion than non-alloyed steel, which, combined with lower thermal conductivity, results in greater distortion under thermal stress.
                  </p>
                </div>
  
                <h3 className="text-xl font-semibold mb-4">
                  Awwa Flanges Specifications
                </h3>
                ...
                <table>
                                ...
                                <tr>
                                  ...
                                  <td><p>As per your drawing<br />
                                      ...
                                      AS, ANSI, BS, DIN and JIS<br />
                                        ...
                                        Equal and AWWA Configurations</p>
                                    </td>
                                ...
                                <tr>
                                  ...
                                  <td><p>ASME DIN, GOST, JIS, UNI, BS, AS2129, AWWA, EN, SABS, NFE etc.<br />
                                    ...
                                    ANSI B16.5 Class 150 AWWA Flanges: -BS Flange, EN Flange, API 6A Flanges, ASME Flanges, ASME Flanges, DIN Flanges, EN1092-1 Flanges, UNI Flanges, JIS/ KS Flanges, BS4504 Flanges, GB Flanges, AWWA C207 Flanges, GOST Flanges, PSI Flangse</p>
                                      ...
                                      <ul> 
                                        ...
                                        <li>DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ANSI B16.5 Class 150 AWWA Flanges</li>
                ...
                <h3 className="text-xl font-semibold mb-4">
                  {" "}
                  Material Grades of Awwa Flanges
                </h3>
            ...
            <tbody>
                  ...
                  <td><strong> Stainless Steel AWWA Flanges</strong></td>
                  ...
                  <td><strong>Carbon Steel AWWA Flanges</strong></td>
                  ...
                  <td><strong>Alloy Steel AWWA Flanges</strong></td>
                  ...
                  <td><strong>Titanium AWWA Flanges</strong></td>
                  ...
                  <td><strong>Copper AWWA Flanges</strong></td>
                  ...
                  <td><strong>Copper Nickel AWWA Flanges</strong></td>
                  ...
                  <td><strong>Inconel AWWA Flanges</strong></td>

                  <td>ASTM B564 / ASME SB564, Inconel 600, 601, 625, 718, 783, 690, x750 ANSI B16.47 Class 150 AWWA Flanges</td>

                  </tr>

                  <tr>

                  <td><strong>Hastelloy AWWA Flanges</strong></td>
                  ...
                  <td><strong>Monel AWWA Flanges</strong></td>
                  ...
                  <td><strong>Alloy 20 AWWA Flanges</strong></td>
                  ...
                  <td><strong>Aluminium AWWA Flanges</strong></td>
                  ...
                  <td><strong>Nickel Alloy AWWA Flanges</strong></td>
                  ...
                  <td><strong>Duplex Steel  AWWA Flanges</strong></td>
                  ...
                  <td><strong>Super Duplex AWWA Flanges</strong></td>
                  ...
                  <td><strong>Incoloy AWWA Flanges</strong></td>
                  ...
                  <td><strong>254 SMO AWWA Flanges</strong></td>
                  ...
                  <td><strong>Nimonic AWWA Flanges</strong></td>
                  ...
                  <td><strong>Brass AWWA Flanges</strong></td>
                  ...
                  <td><strong>Other AWWA Flanges material</strong></td>
                ...
                <table>
                            ...
                            <td colSpan="11" className="bg-primary text-white"><strong>ANSI/ASME/ASA B16.47 150lb/sq.in. Flanges</strong></td>
                            ...
                            <td colSpan="11" className="bg-primary text-white"> <strong>ANSI/ASME/ASA B16.47 600lb/sq.in. Flanges</strong></td>
                ...
                <div className="mb-8">
  <h3 className="text-xl font-semibold mb-4">
    AWWA Pipe Flanges Applications:
  </h3>
  <ul className="list-disc list-inside">
    <li>Water distribution and treatment systems</li>
    <li>Applications requiring high resistance to pitting and crevice corrosion</li>
    <li>Suitable for environments with exposure to chlorides and corrosive conditions</li>
    <li>Used in municipal water systems and industrial water pipelines</li>
    <li>Ideal for applications with high thermal expansion and stress corrosion cracking resistance</li>
    <li>Common in chemical processing and industrial cooling systems</li>
  </ul>
</div>
