...
import inconel600 from "../../../assets/newImages/inconel-buttweld-fittings.webp";

const Inconel600PipeFittings = () => {
  return (
    <div>
      <Layout>
        <div>
            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  Inconel 600 Elbow, Ready Stock Of Alloy 600 Pipe Fittings,
                  Manufacturer of ASTM B366 Inconel Alloy 600 Pipe Elbow, 600
                  Inconel LR Elbow, Nickel Alloyl 600 Buttweld Fittings Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is supplier and manufacturer of Inconel Alloy
                    600 Pipe Fittings, which performs better at high
                    temperatures. This steel's resistance to corrosive
                    environments is not limited to reducing elements, though
                    this is where it excels, as Inconel UNS N06600 Cross Pipe
                    Fittings also performs well in some oxidising conditions. It
                    is resistant to all dry gases at room temperature and can be
                    used in dry chlorine and hydrogen chloride at temperatures
                    up to 550 degrees Celsius. Because of the addition of
                    columbium, this steel has excellent corrosion resistance,
                    even better than alloy steel. For the reason that the
                    required standard will be fully met as specified on the
                    order, the chemical composition of this alloy may vary
                    slightly between different product standards.
                  </p>

                  <div className="mt-5 mb-5  flex items-center justify-center">
                    <img src={inconel600} alt="" width={400} />
                  </div>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Inconel Alloy 600 Butt weld Fittings Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    600 Inconel Pipe Fittings Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default Inconel600PipeFittings;
