...
const StainlessSteel316LFlanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            SS 316L THREADED FLANGES, STAINLESS STEEL 316L SORF FLANGES, MANUFACTURER OF ASTM A182 F316L LAP JOINT FLANGES, READY STOCK OF SS 316L FLANGES, 316L SS LONG WELD NECK FLANGES SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a known stockist and seller of SS 316L Flanges, a chromium alloy used for corrosion and high-temperature resistant applications. Stainless Steel UNS S31603 Orifice Flanges are a common engineering material utilized in environments requiring corrosion and heat resistance. These flanges are a nonmagnetic, nickel-based high-temperature alloy with an excellent combination of strength and toughness. They are oxidation and corrosion-resistant materials, ideally suited for use in high-pressure and high-heat settings. SS 316L flanges exhibit great oxidation resistance up to 1093 degrees Celsius and outstanding carburization resistance. This nickel-chromium alloy is developed for cryogenic applications and is intended for use in environments ranging from cryogenic to extreme temperatures exceeding 2000 degrees Fahrenheit.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 316L Flanges Specifications</h2>
                                ...
                                <tbody>                
                                  ...
                                  DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ASTM A182 F316L Stainless Steel Flanges<br />
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">SS 316L Flanges Equivalent Grades</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 316L Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr  className="bg-primary text-white">
                        ...
                        <td><span >68.89 min</span></td>
                        </tr>
                        </tbody>
                        </table>
                        </div><br />

                        <h2 className="mb-4 mt-4 font-bold text-2xl">316L Stainless Steel Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr  className="bg-primary text-white">
                        ...
                        </div><br />        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Stainless Steel 316L Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default StainlessSteel316LFlanges