...
const StainlessSteel316Flanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            STAINLESS STEEL 316 SORF FLANGES, SS 316 THREADED FLANGES, MANUFACTURER OF ASTM A182 F316 LAP JOINT FLANGES, 316 SS LONG WELD NECK FLANGES, READY STOCK OF SS 316 FLANGES SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a known stockist and distributor of SS 316 Flanges, which perform well in carburizing and chloride-containing conditions. Stainless Steel UNS S31600 Spade Blind Flanges are highly corrosion-resistant due to their high palladium concentration. As a result, these flanges are resistant to saltwater and can handle medium chlorides. They are the most corrosion-resistant of all currently available titanium alloys, making them ideal for applications requiring resistance to both general and targeted crevice corrosion. SS 316 is a non-heat-treatable alloy with high weldability and stability. It is used in aircraft and jet engines because of its weldability, stability, and strength at high temperatures. Additionally, SS 316 is utilized as a stiffening ingredient in graphite composite fishing rods and golf clubs, as well as in cement and gemstones.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 316 Flanges Specifications</h2>
                                ...
                                <tbody>                
                                  ...
                                  DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ASTM A182 F316 Stainless Steel Flanges<br />
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">SS 316 Flanges Equivalent Grades</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 316 Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr  className="bg-primary text-white">
                        ...
                        <tr>
                        <td><strong>SS 316</strong></td>
                        <td><span >0.08 max</span></td>
                        <td>2 max</td>
                        <td><span >1.0 max</span></td>
                        <td><span >0.045 max</span></td>
                        <td><span >0.030 max</span></td>
                        <td><span >16.00 – 18.00</span></td>
                        <td><span >2.00 – 3.00</span></td>
                        <td><span >11.00 – 14.00</span></td>
                        <td><span >67.845 min</span></td>
                        </tr>
                        </tbody>
                        </table>
                        </div><br />

                        <h2 className="mb-4 mt-4 font-bold text-2xl">316 Stainless Steel Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr className="bg-primary text-white">
                        ...
                        </div><br />       <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Stainless Steel 316 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default StainlessSteel316Flanges