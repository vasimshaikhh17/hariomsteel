...
const AlloySteelA182F22Flanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Manufacturer of ASTM A182 Cr-Mo F22 Lap Joint Flanges, Ready Stock Of Chrome Moly F22 Flanges, Alloy Steel F22 SORF Flanges, CrMo F22 Long Weld Neck Flanges, Alloy Steel F22 Threaded Flanges.        </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is supplier of AS ASTM A182 F22 Flanges, which are well-liked by customers due to their robust structure and simple operation. These Alloy Steel ASME SA182 F22 Slip On Flanges, which are manufactured using high-quality materials and sophisticated technology, guarantee better quality and durability. We are committed to providing an unrivalled variety of this steel, which is accessible in bulk quantities as required by the customer. These products provided by us are produced using sophisticated equipment and innovative technology in adherence with the international quality norms and standards. Furthermore, a team of our quality examiners performs a number of quality checks on these products to identify any potential flaws. This service involves the creation of this alloy, which allows them to be technologically sophisticated and effective.            </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F22 Flanges Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F22 Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                       ...
                       <tr className="bg-primary text-white">
                        ...
                        <tr>
                          ...
                          <td><strong>ASTM A182 F22</strong></td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F22 Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <td><strong>Tensile Strength (ksi) min</strong></td>

                        <td><strong>Elongation (% in 50mm) min</strong></td>

                        <td><strong>Yield Strength 0.2% Proof (ksi) min</strong></td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel F22 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default AlloySteelA182F22Flanges
