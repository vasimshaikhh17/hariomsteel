...
import inconelflanges from "../../../assets/newImages/inconel-600-flanges.webp";

const Inconel601Flanges = () => {
  return (
    <div>
      <Layout>
        <div>
            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  Inconel Alloy 601 Threaded Flanges, Ready Stock Of Nickel
                  Alloy 601 Flanges, Manufacturer of ASTM B564 Inconel 601 Lap
                  Joint Flanges, Alloy 601 SORF Flanges, 601 Inconel Long Weld
                  Neck Flanges Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is Supplier of Inconel Alloy 601 Flanges, which
                    demonstrates oxidation, corrosion, and durability
                    resistance. Inconel UNS N06601 Long Weld Neck Flanges is now
                    one of the most prevalent materials used in kitchens. Sinks,
                    tabletops, coffee pots, refrigerators, stoves, cutlery, and
                    other kitchen gadgets all contain it. Bending, forming, deep
                    drawing, and upsetting are common operations for this steel.
                    It is also widely utilised in the construction business,
                    where it is used for aesthetic purposes such as constructing
                    fascia. Because of their durability and outstanding
                    performance, the items we offer are well appreciated in both
                    the local and international markets. The widespread use of
                    this steel in food and beverage and pharmaceutical
                    applications indicates the materials' corrosion resistance.
                  </p>

                  <div className="mt-5 mb-5  flex items-center justify-center">
                    <img src={inconelflanges} alt="" width={400} />
                  </div>

                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Inconel 601 Flanges Specifications
                  </h2>
                  ...
                  <table>
                                <tbody>                
                                  ...
                                  <td>Class 150 LBS, 300 LBS, 601 LBS, 900 LBS, 1500 LBS, 2500 LBS</td>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Inconel 601 Flanges Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                        ...
                        <tr>
                        <td><strong>Inconel 601</strong></td>
                        <td>0.10 max</td>
                        <td>1.00 max</td>
                        <td>0.50 max</td>
                        <td>0.015max</td>
                        <td>1.00 max</td>
                        <td><span className="table-txt">Balance</span></td>
                        <td><span className="table-txt">58.0 – 63.0</span></td>
                        <td><span className="table-txt">21.0 – 25.0</span></td>
                        </tr>
                        </tbody>
                        </table>
                  </div>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    601 Inconel Flanges Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                        ...
                        <tr>
                        <td><strong>Inconel 601</strong></td>
                        <td><span className="table-txt">8.1 g/cm3</span></td>
                        <td><span className="table-txt">1411 °C (2571 °F)</span></td>
                        <td><span className="table-txt">Psi – 80,000 , MPa – 550</span></td>
                        <td><span className="table-txt">Psi – 30,000 , MPa – 205</span></td>
                        <td><span className="table-txt">30 %</span></td>
                        </tr>
                        </tbody>
                        </table>
                  </div>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Weight Chart Of Inconel 601 Flanges
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default Inconel601Flanges;
