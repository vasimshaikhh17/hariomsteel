...
const AlloySteel2H2HMFasteners = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Ready Stock Of Chrome Moly 2H Allen Cap Bolt, Manufacturer of Alloy Steel 2HM Threaded Rod, ASTM A194 Alloy Steel Grade 2HM High Temperature Fasteners, ASTM A194 Alloy Steel Grade 2H Socket Head Cap Screw, Alloy Steel 2H Hex Bolt           </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a well-known supplier of AS 2H / 2HM Fasteners, which are offered at the best market rates.     </p>
              <p className="mb-2 text-justify">
              Our cutting-edge steel machinery is examined and tested on a daily basis to ensure accurate slitting, shearing, and production cutting. Meanwhile, this surface finish metal for our Alloy Steel 2H Nuts has been alloyed with a trace of palladium to improve corrosion protection. These products are used by engineers and the world's best project consultants in machined components, valves, machine tools, pump shafts, fasteners, dairy equipment, and surgical and medical parts. We have enjoyed a long-term relationship with several of our esteemed clients for these products over the years. We suggest that you let us handle the delivery for this alloy because it will be both affordable and effective.
              </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel 2H/2HM Fasteners Specifications</h2>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel 2H/2HM Fasteners Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody><tr><td><strong>Grade</strong></td><td><strong>C</strong></td><td><strong>Mn</strong></td><td><strong>P</strong></td><td><strong>S</strong></td><td><strong>Si</strong></td></tr><tr><td><strong>2H/2HM</strong></td><td>0.40% min</td><td>1.00% max</td><td>0.040%</td><td>0.050%</td><td>0.40% max</td></tr></tbody>
                        </table>
                        </div><br />



                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel 2H/2HM Fasteners Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody><tr><td rowSpan="2"><strong>Specification</strong></td><td rowSpan="2"><strong>Material</strong></td><td rowSpan="2"><strong>Nominal Size, In.</strong></td><td rowSpan="2"><strong>Tempering Temp. °F</strong></td><td rowSpan="2"><strong>Proof Load Stress, ksi</strong></td><td colSpan="2"><strong>Hardness Rockwell</strong></td><td rowSpan="2"><strong>See Note</strong></td></tr><tr><td><strong>Min</strong></td><td><strong>Max</strong></td></tr><tr><td><strong>ASTM A194 Grade 2H/2HM </strong></td><td>Medium Carbon Steel, Quenched and Tempered</td><td>1/4 – 4</td><td>1000</td><td>175</td><td>C24</td><td>C38</td><td>1,2</td></tr></tbody>
                        </table>
                        </div><br />   

                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel 2H/2HM Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
                <thead>
                <tr>
            ...
            <h2 className="mb-4 mt-4 font-bold text-2xl">Dimensions Of Alloy Steel 2H/2HM Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
              <thead>
              <tr>
...
export default AlloySteel2H2HMFasteners
