...
const StainlessSteel316TIFlanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            SS 316TI THREADED FLANGES, MANUFACTURER OF ASTM A182 F316TI LAP JOINT FLANGES, 316TI SS LONG WELD NECK FLANGES, READY STOCK OF SS 316TI FLANGES, STAINLESS STEEL 316TI SORF FLANGES SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a recognised manufacturer and supplier of SS 316Ti Flanges, whichis found in heat treatment equipment as well as gas turbine engine components. Stainless Steel UNS S31635 AWWA Flanges is utilized in the aerospace, automotive, and airframe industries. It offers outstanding stress corrosion cracking resistance at both room and high temperatures. It also has a high strength, strong resistance to aqueous corrosion, and good fabric ability. This alloy's resistance to high-temperature oxidation is a remarkable feature. It is frequently utilized in the chemical process sector, power generation equipment, waste incinerators, and other applications. This alloy's resistance to high-temperature oxidation is a remarkable feature. It renders the material highly impervious to chloride-ion stress-corrosion cracking.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 316Ti Flanges Specifications</h2>
                                ...
                                <tbody>                
                                  ...
                                  DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ASTM A182 F316Ti Stainless Steel Flanges<br />
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">SS 316Ti Flanges Equivalent Grades</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <td><span >68.395 min</span></td>
                        </tr>
                        </tbody>                        </table>
                        </div><br />
                        
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Stainless Steel 316Ti Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr  className="bg-primary text-white">
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">316Ti Stainless Steel Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr  className="bg-primary text-white">
                        ...
                        </div><br />       <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Stainless Steel 316Ti Flanges</h2> 
            <div className="overflow-x-auto">
            <table >
                <tbody>
...
export default StainlessSteel316TIFlanges