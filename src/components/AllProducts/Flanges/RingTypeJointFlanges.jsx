          ...
          <div className="text-fontDefault p-4 prod">
            <div className="customContainer text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-6">
                ...
                <div className="mb-6">
                  <p className="mb-2">
                  Hariom Steels is a distinguished manufacturer of Ring Type Joint Pipe Flanges, which are made from austenitic steel with a high alloy content, providing excellent rust protection. Super Duplex Steel Ring Type Joint Flanges were initially designed to withstand dilute sulfuric acid conditions. These flanges offer resistance to stress corrosion cracking and acidic corrosion caused by chlorides. They are used in various applications, including chemical processing, gas and oil well pipelines, pollution control components, acid generation, heat exchangers, and pickling parts. Additionally, they are commonly used in seawater management, food and beverage processing, hydrometallurgy, and pharmaceuticals. These flanges are known for their great formability and weldability, as well as their strong resistance to crevice and stress corrosion cracking..
                  </p>
                </div>
  
                <h3 className="text-xl font-semibold mb-4">
                  Ring Type Joint Flanges Specifications
                </h3>
                ...
                <table>
                                ...
                                <tr>
                                  ...
                                  <td><p>ASME DIN, GOST, JIS, UNI, BS, AS2129, AWWA, EN, SABS, NFE etc.<br />
                                    ...
                                    ANSI B16.5 Class 150 Ring Type Joint Flanges: -BS Flange, EN Flange, API 6A Flanges, ASME Flanges, ASME Flanges, DIN Flanges, EN1092-1 Flanges, UNI Flanges, JIS/ KS Flanges, BS4504 Flanges, GB Flanges, AWWA C207 Flanges, GOST Flanges, PSI Flangse</p>
                                      ...
                                      <ul> 
                                        ...
                                        <li>DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ANSI B16.5 Class 150 Ring Type Joint Flanges</li>
            ...
            <tbody>
                  ...
                  <td><strong> Stainless Steel Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Carbon Steel Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Alloy Steel Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Titanium Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Copper Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Copper Nickel Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Inconel Ring Type Joint Flanges</strong></td>

                  <td>ASTM B564 / ASME SB564, Inconel 600, 601, 625, 718, 783, 690, x750 ANSI B16.5 Class 150 Ring Type Joint Flanges</td>

                  </tr>

                  <tr>

                  <td><strong>Hastelloy Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Monel Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Alloy 20 Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Aluminium Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Nickel Alloy Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Duplex Steel Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Super Duplex Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Incoloy Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>254 SMO Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Nimonic Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Brass Ring Type Joint Flanges</strong></td>
                  ...
                  <td><strong>Other Ring Type Joint Flanges material</strong></td>
                ...
                <h2 className="text-2xl font-bold mb-4">
                  Ring Type Joint Flanges Dimensions Chart:
                </h2>
  
                {/* <img src={ringTypeJointFlanges} alt="" /> */}
                <br />
                ...
                <table>
                            ...
                            <td colSpan="11" className="bg-primary text-white"><strong>ANSI/ASME/ASA B16.5 150lb/sq.in. Flanges</strong></td>
                ...
                <div className="mb-8">
  <h3 className="text-xl font-semibold mb-4">
    Ring Type Joint Flanges Applications:
  </h3>
  <ul className="list-disc list-inside">
    <li>Chemical processing and acid generation systems</li>
    <li>Gas and oil well pipelines</li>
    <li>Pollution control equipment</li>
    <li>Heat exchangers and pickling parts</li>
    <li>Seawater management and food and beverage processing</li>
    <li>Hydrometallurgy and pharmaceutical applications</li>
    <li>High-pressure and high-temperature environments</li>
  </ul>
</div>
