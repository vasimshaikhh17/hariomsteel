...
import reducingFlanges from "../../../assets/newImages/reducing flange.png";
          ...
          <div className="text-fontDefault p-4 prod">
            <div className="customContainer text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-6">
                ...
                <div className="mb-6">
                  <p className="mb-2">
                  Hariom Steels is a distinguished exporter of Reducing Pipe Flanges, which are weldable but can be susceptible to heated fractures. Alloy 20 Reducing Flanges are made from super austenitic steel, designed to offer intermediate to high corrosion protection in various industrial environments. While these flanges exhibit exceptional resilience to hot marine water and chloride conditions, they are not completely immune to severe laboratory tests, such as exposure to boiling magnesium or lithium chlorides. They are generally resistant to uniform corrosion in environments where the corrosion rate remains within acceptable limits. Copper back-up plates can aid in faster heat rejection; however, surface-fusing these plates is not permitted to avoid cracking in the solder metal.
                  </p>
                </div>
  
                <h3 className="text-xl font-semibold mb-4">
                  Reducing Flanges Specifications
                </h3>
                ...
                <table>
                                ...
                                <tr>
                                  ...
                                  <td><p>ASME DIN, GOST, JIS, UNI, BS, AS2129, AWWA, EN, SABS, NFE etc.<br />
                                    ...
                                    ANSI B16.5 Class 150 Reducing Flanges: -BS Flange, EN Flange, API 6A Flanges, ASME Flanges, ASME Flanges, DIN Flanges, EN1092-1 Flanges, UNI Flanges, JIS/ KS Flanges, BS4504 Flanges, GB Flanges, AWWA C207 Flanges, GOST Flanges, PSI Flangse</p>
                                      ...
                                      <ul> 
                                        ...
                                        <li>DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ANSI B16.5 Class 150 Reducing Flanges</li>
            ...
            <tbody>
                  ...
                  <td><strong> Stainless Steel Reducing Flanges</strong></td>
                  ...
                  <td><strong>Carbon Steel Reducing Flanges</strong></td>
                  ...
                  <td><strong>Alloy Steel Reducing Flanges</strong></td>
                  ...
                  <td><strong>Titanium Reducing Flanges</strong></td>
                  ...
                  <td><strong>Copper Reducing Flanges</strong></td>
                  ...
                  <td><strong>Copper Nickel Reducing Flanges</strong></td>
                  ...
                  <td><strong>Inconel Reducing Flanges</strong></td>

                  <td>ASTM B564 / ASME SB564, Inconel 600, 601, 625, 718, 783, 690, x750 ANSI B16.5 Class 150 Reducing Flanges</td>

                  </tr>

                  <tr>

                  <td><strong>Hastelloy Reducing Flanges</strong></td>
                  ...
                  <td><strong>Monel Reducing Flanges</strong></td>
                  ...
                  <td><strong>Alloy 20 Reducing Flanges</strong></td>
                  ...
                  <td><strong>Aluminium Reducing Flanges</strong></td>
                  ...
                  <td><strong>Nickel Alloy Reducing Flanges</strong></td>
                  ...
                  <td><strong>Duplex Steel  Reducing Flanges</strong></td>
                  ...
                  <td><strong>Super Duplex Reducing Flanges</strong></td>
                  ...
                  <td><strong>Incoloy Reducing Flanges</strong></td>
                  ...
                  <td><strong>254 SMO Reducing Flanges</strong></td>
                  ...
                  <td><strong>Nimonic Reducing Flanges</strong></td>
                  ...
                  <td><strong>Brass Reducing Flanges</strong></td>
                  ...
                  <td><strong>Other Reducing Flanges material</strong></td>
                ...
                <h2 className="text-2xl font-bold mb-4">
                  Reducing Flanges Dimensions Chart:
                </h2>
  
                {/* <img src={reducingFlanges} alt="" /> */}
                <br />
