      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Manufacturer of Chrome Moly B6 Threaded Rod, Alloy Steel B6 Socket Head Cap Screw, B6 Alloy Steel High Temperature Fasteners, Ready Stock Of Cr-Mo Gr. B6 Allen Cap Bolt, Alloy Steel B6 Hex Bolt         </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a well-known supplier of AS B6 Fasteners, which resists stress-corrosion cracking and pitting well.    </p>
              <p className="mb-2 text-justify">
              Alloy Steel B6 Nuts are resistant to creep and oxidation. Because this limited chemistry may be utilised in the welded condition and is less prone to SCC under various situations, stringent chemistry control and years of development have resulted in this steel being used today. This steel is a nickel-chromium-iron-molybdenum alloy designed to withstand corrosion in both oxidising and reducing environments. This steel may be utilised at temperatures of up to 1000 degrees Fahrenheit in oxidising gases such as air (538 Degree C). To ensure that all impurities and marks are eliminated, the work item for this steel should be carefully cleaned with acetone or other appropriate cleansers.
              </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B6 Fasteners Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B6 Fasteners Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr height="30">
                        <td rowSpan="2"><strong>Alloy Steel B6</strong></td>
                        ...
                        <td>11.50-13.50</td>
                              ...
                              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B6 Fasteners Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr height="30">
                        <td ><strong>Yield<br />
                        <abbr title="Minimum yield strength / Mindestwert der oberen Streckgrenze / Limite d'elasticite minimale"><i>R</i><sub>p0.2</sub></abbr> (MPa)</strong></td>
                        <td ><strong>Tensile<br />
                        <abbr title="Tensile strength / Zugfestigkeit / Resistance a la traction"><i>R</i><sub>m</sub></abbr> (MPa)</strong></td>
                        <td ><strong>Impact<br />
                        KV/Ku (<abbr title="Notch impact test / Kerbschlagbiegeversuch / Essai de flexion par choc">J</abbr>)</strong></td>
                        <td ><strong>Elongation<br />
                        <i><abbr title="Minimum elongation / Mindestwert der Bruchdehnung / Allongement minimal">A</abbr></i> (%)</strong></td>
                        <td ><strong>Reduction in cross section on fracture<br />
                        <i>Z</i> (%)</strong></td>
                        <td ><strong>As-Heat-Treated Condition</strong></td>
                        <td ><strong>Brinell hardness (HBW)</strong></td>
                        </tr>
                        <tr height="30">
                        <td>666 (≥)</td>
                        <td>997 (≥)</td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel B6 Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
                <thead>
                <tr>
            ...
            <h2 className="mb-4 mt-4 font-bold text-2xl">Dimensions Of Alloy Steel B6 Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
            <thead>
              <tr>
...
export default AlloySteelB6Fasteners
