...
import hastelloyc22 from "../../../assets/newImages/hastelloy-c22-pipefitting.webp";

const HastelloyC22PipeFittings = () => {
  return (
    <div>
      <Layout>
        <div>
            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  Nickel Alloy C22 Buttweld Fittings, Ready Stock Of Alloy C22
                  Pipe Fittings, Hastelloy C22 Elbow, C22 Hastelloy LR Elbow,
                  Manufacturer of ASTM B366 Hastelloy Alloy C22 Pipe Elbow
                  Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is a supplier of Hastelloy Alloy C22
                    Pipe Fittings, whichis intended to withstand deformation at
                    high temperatures. Hastelloy UNS N06022 Elbow Pipe Fittings
                    have a high corrosion resistance in reduction, oxidation,
                    nitric, and other environments. It is a common technical
                    material with high heat and corrosion resistance. This steel
                    offers great mechanical qualities and a desired mix of
                    strength and workability.They provide static applications at
                    high temperatures. This product finds application in the
                    chemical process sector, heat treatment fixtures, aeroplane
                    components, and nuclear reactors. This product offers
                    excellent workability, weld ability, and strength. Sudden
                    temperature swings (which are typical in heat treat
                    applications) are less of a concern for this product since
                    it is resistant to thermal shock.
                  </p>

                  <div className="mt-5 mb-5  flex items-center justify-center">
                    <img src={hastelloyc22} alt="" width={400} />
                  </div>

                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Hastelloy Alloy C22 Pipe Fittings Specifications
                  </h2>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Hastelloy Alloy C22 Butt weld Fittings Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    C22 Hastelloy Pipe Fittings Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Hastelloy Alloy C22 Pipe Fittings Thickness Chart
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default HastelloyC22PipeFittings;
