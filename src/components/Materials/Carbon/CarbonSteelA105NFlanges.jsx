      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            CARBON STEEL A105 LONG WELD NECK FLANGES, READY STOCK OF CS A105 FLANGES, CARBON STEEL A105N THREADED FLANGES, MANUFACTURER OF ASTM A105 CARBON STEEL LAP JOINT FLANGES, CARBON STEEL A105N SORF FLANGES SUPPLIER
            </h1>
{/* 
...
Hariom Steel is an acknowledged supplier and seller of CS A105N Flanges, which is an austenitic chromium-nickel metal stabilized with columbium and tantalum. Carbon Steel ASTM A105N Slip On Flanges are highly corrosion resistant in a broad variety of chemicals, particularly acidic chloride conditions like those found in pulp and paper factories. They are nonmagnetic when heated, but can become mildly magnetic after welding. These flanges are corrosion-resistant austenitic chromium-nickel-molybdenum metals with minimal carbon content, offering great strength and corrosion protection, along with high chromium and nickel ratios. Except for oxyacetylene welding, all standard fusion and resistance methods for this product have been effective. After completing the process, they are evaluated on various criteria to ensure that we provide a faultless variety to our clients.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Carbon Steel A105N Flanges Specifications</h2>
                                ...
                                <br />
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Carbon Steel A105N Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                ...
                {/* weight chart */}
                {/* dimensionchart */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Carbon Steel A105N Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default CarbonSteelA105NFlanges