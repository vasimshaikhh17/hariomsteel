      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            CrMo F5 Long Weld Neck Flanges, Manufacturer of ASTM A182 Cr-Mo F5 Lap Joint Flanges, Alloy Steel F5 SORF Flanges, Alloy Steel F5 Threaded Flanges, Ready Stock Of Chrome Moly F5 Flanges        </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is Supplier of AS ASTM A182 F5 Flanges, which are tailored to the needs of the customer. Alloy Steel ASME SA182 F5 Socket Weld Flanges are a preferred choice in the majority of important uses because there is no risk of impurities that are commonly linked by welded coiled. It has a broad range of uses, including natural gas, petrochemical, oil and gas, and geothermal. They are well-known in the market for their applications in agriculture, potable water for homes, collieries for water extraction, thermal power, and other fields. We give a broad and complete variety of these products, which are renowned for their extremely excellent performance, due to the expertise and proficient team of diligent people.             </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F5 Flanges Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F5 Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <tr>
                        <td><strong>Alloy Steel F5</strong></td>
                        <td>0.15 max</td>
                        <td>&nbsp;0.3-0.6</td>
                        <td>0.5-1.0</td>
                        <td>&nbsp;0.03</td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F5 Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr className="bg-primary text-white">
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel F5 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default AlloySteelA182F5Flanges
