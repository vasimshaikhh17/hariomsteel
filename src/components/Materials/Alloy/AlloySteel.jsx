...
const AlloySteel = () => {
  ...
  const alloySteel = materialGrade.find(item => item.title === "Alloy Steel");

  return (
    <Layout>
      <div className="py-8 customContainer">
        <h2 className="text-3xl font-bold text-center mb-8">Alloy Steel</h2>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {alloySteel.sub_sub_category.map(subCategory => (
