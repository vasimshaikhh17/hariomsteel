...
import hastelloyc276 from "../../../assets/newImages/hastellot-c276-pipefitting.jpg";

const HastelloyC276PipeFittings = () => {
  return (
    <div>
      <Layout>
        <div>
            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  Hastelloy C276 Elbow, Manufacturer of ASTM B366 Hastelloy
                  Alloy C276 Pipe Elbow, C276 Hastelloy LR Elbow, Nickel Alloyl
                  C276 Buttweld Fittings, Ready Stock Of Alloy C276 Pipe
                  Fittings Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is a supplier of Hastelloy Alloy C276 Pipe
                    Fittings, which are resistant to oxidation at high
                    temperatures. Hastelloy UNS N10276 Buttweld Cross Fittings
                    offer great oxidation resistance up to 1093 degrees Celsius
                    in addition to outstanding carburization resistance. This
                    steel has a high strength and is easily produced. Because of
                    their high nickel content, they are resistant to corrosion
                    by a wide range of organic and inorganic chemicals. It's
                    also employed in the chemical sector, heat treatment
                    fixtures, aeroplane components, and nuclear reactors. They
                    are resistant to corrosion in both organic and inorganic
                    chemicals. We have decades of expertise selling specialised
                    materials such as this one for essential applications in
                    some of the world's most demanding industries.
                  </p>

                  <div className="mt-5 mb-5  flex items-center justify-center">
                    <img src={hastelloyc276} alt="" width={600} />
                  </div>

                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Hastelloy Alloy C276 Pipe Fittings Specifications
                  </h2>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Hastelloy Alloy C276 Butt weld Fittings Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    C276 Hastelloy Pipe Fittings Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Hastelloy Alloy C276 Pipe Fittings Thickness Chart
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default HastelloyC276PipeFittings;
