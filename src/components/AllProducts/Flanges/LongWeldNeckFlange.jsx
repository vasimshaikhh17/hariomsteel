          ...
          <div className="text-fontDefault p-4 prod">
            <div className="customContainer text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-6">
                ...
                <div className="mb-6">
                  <p className="mb-2">
                  Hariom Steels is a distinguished supplier of Long Weld Neck Pipe Flanges, which are commonly hardened yet remain machinable. Duplex Steel Long Weld Neck Flanges offer modest corrosion protection across various environments, positioned between standard austenitic alloys and highly alloyed molybdenum types. However, they are not entirely impervious to environmental conditions such as aerated saltwater. Due to the tendency of this steel, combined with austenitic weld metal and excessive heat input, to develop heat cracks, it is essential to grind tacks or ensure they are free of crater cracks. These flanges have a wide range of applications, including in dentistry and surgical tools, pipes, valves and nozzles, automobile components, and more.
                  </p>
                </div>
  
                <h3 className="text-xl font-semibold mb-4">
                  Long Weld Neck Flanges Specifications
                </h3>
                ...
                <table>
                                ...
                                <tr>
                                  ...
                                  <td><p>ASME DIN, GOST, JIS, UNI, BS, AS2129, AWWA, EN, SABS, NFE etc.<br />
                                    ...
                                    ANSI B16.5 Class 150 Long Weld Neck Flanges: -BS Flange, EN Flange, API 6A Flanges, ASME Flanges, ASME Flanges, DIN Flanges, EN1092-1 Flanges, UNI Flanges, JIS/ KS Flanges, BS4504 Flanges, GB Flanges, AWWA C207 Flanges, GOST Flanges, PSI Flangse</p>
                                      ...
                                      <ul> 
                                        ...
                                        <li>DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ANSI B16.5 Class 150 Long Weld Neck Flanges</li>
                ...
                <h3 className="text-xl font-semibold mb-4">
                  {" "}
                  Material Grades of Long Weld Neck Flanges
                </h3>
            ...
            <tbody>
                  ...
                  <td><strong> Stainless Steel Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Carbon Steel Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Alloy Steel Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Titanium Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Copper Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Copper Nickel Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Inconel Long Weld Neck Flanges</strong></td>

                  <td>ASTM B564 / ASME SB564, Inconel 600, 601, 625, 718, 783, 690, x750 ANSI B16.5 Class 150 Long Weld Neck Flanges</td>

                  </tr>

                  <tr>

                  <td><strong>Hastelloy Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Monel Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Alloy 20 Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Aluminium Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Nickel Alloy Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Duplex Steel  Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Super Duplex Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Incoloy Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>254 SMO Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Nimonic Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Brass Long Weld Neck Flanges</strong></td>
                  ...
                  <td><strong>Other Long Weld Neck Flanges material</strong></td>
                ...
                <h2 className="text-2xl font-bold mb-4">
                  Long Weld Neck Flanges Dimensions Chart:
                </h2>
  
                {/* <img src={longWeldNeckFlanges} alt="" /> */}
                <br />
                ...
                <div className="mb-8">
  <h3 className="text-xl font-semibold mb-4">
    Long Weld Neck Flanges Applications:
  </h3>
  <ul className="list-disc list-inside">
    <li>High-pressure and high-temperature piping systems</li>
    <li>Applications requiring robust joint integrity and alignment</li>
    <li>Used in sectors such as chemical processing and petrochemical industries</li>
    <li>Suitable for applications with moderate corrosion protection needs</li>
    <li>Common in valves, nozzles, and heavy-duty pipe systems</li>
    <li>Ideal for use in industries like automotive, aerospace, and industrial machinery</li>
  </ul>
</div>
