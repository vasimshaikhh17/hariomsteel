...
import carbonFLANG from "../../../assets/newImages/carbon-steel-flanges.jpg";
import AnimatedBars from "../AnimatedBars.jsx";
import React from "react";
const SA516Gr6070SpectacleBlindFlange = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            MANUFACTURER OF SPECTACLE BLIND FLANGE, LTCS A516 GR.70 SPECTACLE BLIND FLANGES, READY STOCK OF SA516 GR. 60 SPECTACLE BLIND FLANGES, A516 GR.70 SPECTACLE BLIND WELD FLANGE, LTCS A516 GR.60 SPECTACLE BLIND FLANGES SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is an acknowledged manufacturer and supplier of Carbon Steel SA 516 Gr 60/70 Spectacle Blind Flanges, available at affordable prices. We offer these Carbon Steel ASME SA 516 Gr 60/70 Spectacle Blind Flanges in various forms suitable for irrigation and other applications. Our flanges are designed from high-grade metals and fabricated using cutting-edge technology to ensure durability. The steel's accessories feature a smooth interior surface for trouble-free conveyance of water, steam, oil, chemicals, gas, and air. Common applications include marine uses, directional drilling, musical instruments, pharmaceutical and petrochemical industries, and offshore operations. These flanges are efficient and cost-effective alloying elements that significantly enhance strength, especially when added to fully de-oxidized low carbon steel.
              </p>

              <div className="mt-5 mb-5  flex items-center justify-center">
                <img src={carbonFLANG} alt="" width={600} />
              </div>

                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">SA 516 Gr 60/70 Spectacle Blind Flange Specifications</h2>
                                ...
                                <tbody>                
                                  ...
                                  DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ASTM A182 F316 Carbon Steel Flanges<br />
                ...
                <h2 className="mb-4 mt-4 font-bold text-2xl">SA 516 Gr 60/70 Spectacle Blind Flange Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <td><strong>SA 516 Gr70</strong></td>
                ...
                {/* mechnical property */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">SA 516 Gr 60/70 Spectacle Blind Flange Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                ...
                {/* weight chart */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of SA 516 Gr 60/70 Spectacle Blind Flange</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default SA516Gr6070SpectacleBlindFlange