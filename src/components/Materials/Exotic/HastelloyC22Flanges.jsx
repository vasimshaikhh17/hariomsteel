            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  Alloy C22 SORF Flanges, C22 Hastelloy Long Weld Neck Flanges,
                  Ready Stock Of Nickel Alloy C22 Flanges, Manufacturer of ASTM
                  B564 Hastelloy C22 Lap Joint Flanges, Hastelloy Alloy C22
                  Threaded Flanges Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is a supplier of Hastelloy Alloy C22 Flanges,
                    which is more resistant to intergranular corrosion.
                    Hastelloy UNS N06022 Slip On Flanges is a
                    columbium-containing stabilised austenitic chromium nickel
                    steel that eliminates carbide precipitation and, as a
                    result, inter-granular corrosion. It is frequently utilised
                    as a stabilised alternative when columbium is employed as
                    the stabilising agent. Because of its low tantalum and
                    cobalt content, it should be evaluated for nuclear
                    applications.Collector rings, annealing box covers, aviation
                    exhaust heaps, jet engine parts, tubing, fasteners, flexible
                    metal bellows and hose, expansion joints, and other
                    applications call for it. These are iron-based alloys with
                    at least 10.5 percent chromium content.
                  </p>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  Hastelloy C22 Flanges Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  C22 Hastelloy Flanges Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  Weight Chart Of Hastelloy C22 Flanges
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default HastelloyC22Flanges;
