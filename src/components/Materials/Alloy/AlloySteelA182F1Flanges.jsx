      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Alloy Steel F1 SORF Flanges, Manufacturer of ASTM A182 Cr-Mo F1 Lap Joint Flanges, Ready Stock Of Chrome Moly F1 Flanges, CrMo F1 Long Weld Neck Flanges, Alloy Steel F1 Threaded Flanges        </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is supplier of AS ASTM A182 F1 Flanges, whichare offered in various metre lengths or customised widths to meet the needs of the clients. Alloy Steel ASME SA182 F1 Slip On Flanges is used in the production of stamped parts, household products, aeroplanes, and automobile components. It has some unique characteristics to give, such as good heat treatment properties, strong electric properties, and well-known thermal properties. We are recognised as a trustworthy and leading producer and seller of a very high quality and premium variety of these products, which are made by our experts using quality-assured steel and leading methods in line with industry standards. Most common sizes of these products are available ex-stock for immediate delivery to our customers.             </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F1 Flanges Specifications</h2>
                                ...
                                <tbody>                
                                  ...
                                  DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ASTM A182 F316 Alloy Steel Flanges<br />
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F1 Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <tr>
                        <td><strong>Alloy Steel F1</strong></td>
                        <td>0.15 max</td>
                        <td>0.3-0.6</td>
                        <td>0.5</td>
                        <td>0.03</td>
...
<h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F1 Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr className="bg-primary text-white"><td width="10%"><strong>Grade</strong></td>
                        <td width="15%"><strong>Tensile Strength (MPa) min</strong></td>
                        <td width="25%"><strong>Yield Strength 0.2% Proof (MPa) min</strong></td>
                        <td width="20%"><strong>Elongation (% in 50mm) min</strong></td>
                        </tr>
                        <tr>
                        <td><strong>Alloy Steel F1</strong></td>
                        <td>275</td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel F1 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default AlloySteelA182F1Flanges
