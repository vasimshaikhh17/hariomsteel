                    ...
                    <div className="customContainer text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
                        <div className="lg:w-3/4 lg:pr-6">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="mb-2">
                                    Buttweld Elbows are crucial components used in piping systems to change the direction of flow. Available in different angles like 45°, 90°, and 180°, these fittings are used extensively in industries such as oil and gas, chemical processing, and power generation. Buttweld Elbows are known for their strength and durability, ensuring a secure and leak-proof connection.
                                </p>
                                <p className="mb-2">
                                    These fittings are designed to withstand high pressure and high temperatures, making them ideal for challenging environments.
                                </p>
                            ...
                            <div className="mt-8">
                                <h2 className="text-2xl font-semibold text-gray-800 mb-4">
                                    Buttweld Elbow Characteristics
                                </h2>
