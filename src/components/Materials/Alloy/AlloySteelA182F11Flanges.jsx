...
const AlloySteelA182F11Flanges = () => {
  return (
    <Layout>
    <div>
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Alloy Steel F11 Threaded Flanges, CrMo F11 Long Weld Neck Flanges, Manufacturer of ASTM A182 Cr-Mo F11 Lap Joint Flanges, Ready Stock Of Chrome Moly F11 Flanges, Alloy Steel F11 SORF Flanges.        </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is Supplier of AS ASTM A182 F11 Flanges, which are available in a broad variety of grades, lengths, and forms, and are also renowned for their rust resilience. Alloy Steel ASME SA182 F11 Long Weld Neck Flanges has a number of exceptional features to provide like simple to install, can withstand high pressure, high strength, and so on. The provided products are easily accessible in a variety of specifications to meet the needs of the clients. Our dependable specialists manufacture the presented products with the highest grade of steel. To strengthen our position, we successfully give a broad and quality-assured variety of these products, which are in high demand in the market due to their precise dimensions and ease of installation. Our offered products are examined by quality experts to ensure that they are ideal.            </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F11 Flanges Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl"> Alloy Steel F11 Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                              ...
                              <tr className="bg-primary text-white">
                                ...
                                <tr>
                                  ...
                                  <td><strong>ASTM A182 F11</strong></td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F11 Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                     ...
                     <tr className="bg-primary text-white">
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel F11 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default AlloySteelA182F11Flanges
