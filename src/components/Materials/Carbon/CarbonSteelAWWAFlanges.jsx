      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            MANUFACTURER OF AWWA C207 LAP JOINT FLANGES, C207 AWWA THREADED FLANGES, READY STOCK OF CS AWWA C207 FLANGES, CARBON STEEL AWWA SORF FLANGES, CARBON STEEL AWWA C207 LONG WELD NECK FLANGES SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a supplier of CS AWWA Flanges, available in a range of shapes and thicknesses. Carbon Steel AWWA Ring Joint Flanges are widely used across various sectors and are known for their enhanced durability and corrosion resistance. We offer this steel, which has been rigorously tested on numerous quality criteria to ensure a long-lasting product. As one of the most reliable names in the industry, we provide a broad range of this alloy to our valued customers. Our products are made using the highest quality materials and advanced technology under expert supervision. We maintain a large selection of these goods, all crafted from high-quality steel.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                <h2 className="mb-4 mt-4 font-bold text-2xl">Carbon Steel AWWA Flanges Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Carbon Steel AWWA Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default CarbonSteelAWWAFlanges