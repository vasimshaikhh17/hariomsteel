...
import hastelloyflanges from "../../../assets/newImages/hastelloy-c22-flanges.jpg"

const HastelloyC276Flanges = () => {
  return (
    <div>
      <Layout>
        <div>
            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  C276 Hastelloy Long Weld Neck Flanges, Manufacturer of ASTM
                  B564 Hastelloy C276 Lap Joint Flanges, Alloy C276 SORF
                  Flanges, Hastelloy Alloy C276 Threaded Flanges, Ready Stock Of
                  Nickel Alloy C276 Flanges Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is a supplier of Hastelloy Alloy C276 Flanges,
                    which are found in chemical manufacturing and exhaust
                    manifolds equipment. Hastelloy WNR 2.4819 Socket Weld
                    Flanges can be utilised in applications that need repeated
                    heating between 800 and 1650 degrees Fahrenheit (427 Degree
                    C - 899 Degree C). They are highly inured to the effects of
                    sulphurous fumes, particularly over 900 degrees Celsius,
                    which is extremely low. It is preferred for aqueous and low
                    temperature conditions because to its strong resistance to
                    inter-granular assault when stabilised with columbium. The
                    inclusion of columbium and tantalum stabilises them. After
                    being exposed to this temperature range, it possesses high
                    inter-granular corrosion resistance. Moreover, the columbium
                    permits this steel to be repeatedly heated to temperatures
                    of up to 1650 degrees Fahrenheit.
                  </p>

                  <div className="mt-5 mb-5  flex items-center justify-center">
                    <img src={hastelloyflanges} alt="" width={400} />
                  </div>
                  ...
                  <table>
                                <tbody>                
                                  ...
                                  DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ASTM B564 F316 Stainless Steel Flanges<br/>
                  ...
                  <table>
                        ...
                        <td>0.010 max</td>
                        <td><span className="table-txt">1.00 max</span></td>
                        <td>0.08 max</td>
                        <td><span className="table-txt">0.03 max</span></td>
                        <td>2.50 max</td>
                        <td><span className="table-txt">50.99 min*</span></td>
                        <td><span className="table-txt">14.50 – 16.50</span></td>
                        <td><span className="table-txt">4.00 – 7.00</span></td>
                        <td><span className="table-txt">15.00 – 17.00</span></td>
                        <td>0.04 max</td>
                        </tr>
                        </tbody>
                        </table>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  C276 Hastelloy Flanges Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                        ...
                        <td><span className="table-txt">8.89 g/cm3</span></td>
                        <td><span className="table-txt">1370 °C (2500 °F)</span></td>
                        <td><span className="table-txt">Psi – 1,15,000 , MPa – 790</span></td>
                        <td><span className="table-txt">Psi – 52,000 , MPa – 355</span></td>
                        <td>40 %</td>
                        </tr>
                        </tbody>
                        </table>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  Weight Chart Of Hastelloy C276 Flangeses
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default HastelloyC276Flanges;
