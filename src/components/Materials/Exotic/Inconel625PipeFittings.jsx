...
import inconel625 from "../../../assets/newImages/inconel-buttweld-fittings.webp";

const Inconel625PipeFittings = () => {
  return (
    <div>
      <Layout>
        <div>
            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  Nickel Alloy 625 Buttweld Fittings, Inconel 625 Elbow,
                  Manufacturer of ASTM B366 Inconel Alloy 625 Pipe Elbow, 625
                  Inconel LR Elbow, Ready Stock Of Alloy 625 Pipe Fittings
                  Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is supplier of Inconel Alloy 625 Pipe Fittings,
                    whichis an alloyed molybdenum bearing austenitic chromium
                    nickel steel. Inconel UNS N06625 2D Elbow Pipe Fittings is
                    tougher than other steels with a long stringy chip, so chip
                    breakers are recommended in this alloy. Because of the
                    benefits and chemical composition of this product, it is
                    widely used in a variety of industries for a wide range of
                    applications. This steel should be annealed at temperatures
                    ranging from 1010 to 1121 degrees Celsius (1850 to 2050
                    degrees Fahrenheit), followed by rapid cooling. They are
                    resistant to concentrations of this acid at temperatures as
                    high as 120 degrees Fahrenheit (49 degrees Celsius).
                    Shielded fusion and resistance methods can be used to weld
                    it, but oxyacetylene welding should be avoided to avoid
                    carbon pick up in the welds.
                  </p>

                  <div className="mt-5 mb-5  flex items-center justify-center">
                    <img src={inconel625} alt="" width={400} />
                  </div>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Inconel Alloy 625 Butt weld Fittings Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    625 Inconel Pipe Fittings Mechanical Properties
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                    Inconel Alloy 600 Pipe Fittings Thickness Chart
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default Inconel625PipeFittings;
