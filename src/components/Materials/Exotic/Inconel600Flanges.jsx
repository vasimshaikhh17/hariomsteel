            ...
            <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-2">
                <h1 className="text-xl md:text-3xl font-bold mb-4 ">
                  Manufacturer of ASTM B564 Inconel 600 Lap Joint Flanges,
                  Inconel Alloy 600 Threaded Flanges, Alloy 600 SORF Flanges,
                  Ready Stock Of Nickel Alloy 600 Flanges, 600 Inconel Long Weld
                  Neck Flanges Supplier
                </h1>

                <div className="mb-6">
                  <p className="mb-2 text-justify">
                    Hariom Steel is Supplier of Inconel Alloy 600 Flanges, which
                    is considered to operate consistently in most corrosive
                    situations. Inconel UNS N06600 Reducing Flanges is resistant
                    to corrosion due by numerous compounds found in several
                    items. It cannot be included in this equation due to the
                    increased carbon content of the steel, which is meant for
                    use in high-temperature applications. Because it is sturdy,
                    simple to clean, and corrosion resistant to different acids
                    present in several sustenance items, it is utilised in
                    everything from appliances to cookware, dishware, flatware,
                    and utensils.If future water corrosion resistance is
                    necessary, continuous usage of this alloy in the 800° F -
                    1580° F range is not suggested. They are produced at our
                    facility utilising high-quality raw materials obtained from
                    reputable market specialists.
                  </p>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  Inconel 600 Flanges Chemical Composition
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  600 Inconel Flanges Mechanical Properties 
                  </h2>
                  <div className="overflow-x-auto">
                  <table>
                        <tbody>
                  ...
                  <h2 className="mb-4 mt-4 font-bold text-2xl">
                  Weight Chart Of Inconel 600 Flanges
                  </h2>
                  <div className="overflow-x-auto">
                    <table>
                      <tbody>
...
export default Inconel600Flanges;
