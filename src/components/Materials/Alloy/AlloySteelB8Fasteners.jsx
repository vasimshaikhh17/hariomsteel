      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            B8 Alloy Steel High Temperature Fasteners, Manufacturer of Chrome Moly B8 Threaded Rod, Alloy Steel B8 Hex Bolt, Ready Stock Of Cr-Mo Gr. B8 Allen Cap Bolt, Alloy Steel B8 Socket Head Cap Screw          </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a well-known supplier of AS B8 Fasteners, whichare dependable and long-lasting, as well as meeting safety standards and worldwide quality.    </p>
              <p className="mb-2 text-justify">
              Alloy Steel B8 Nuts is quality examined by professional and expert analyzers on a regular basis to ensure soaring durability. Controlling and monitoring instruments for these products, which are critical in turbines and nuclear islands of reactors, are also required for our soaring performance tubes. These products' characteristics are extensively used in offshore oil and gas research and production, as well as heat exchangers in petrochemical and chemical processing. They are also used in salt water piling wrap, hot water tanks, salt water baffles, propeller sleeves, ship hulls, and water hoses, among other applications.
              </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B8 Fasteners Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B8 Fasteners Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody><tr><td><strong>Grade</strong></td><td><strong>C</strong></td><td><strong>Mn</strong></td><td><strong>P</strong></td><td><strong>S</strong></td><td><strong>Si</strong></td><td><strong>Cr</strong></td><td><strong>Ni</strong></td></tr><tr><td><strong>B8</strong></td><td>0.08% max</td><td>2.00% max</td><td>0.045%</td><td>0.030%</td><td>1.00% max</td><td>18.0 - 20.0%</td><td>8.0 - 11.0%</td></tr></tbody>
                        </table>
                        </div><br />


                        
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel B8 Fasteners Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody><tr><td><strong>Grade</strong></td><td><strong>Tensile Strength (MPa) min</strong></td><td><strong>Yield Strength 0.2% Proof (MPa) min</strong></td><td><strong>Elongation (% in 50mm) min</strong></td><td><strong>RA % min</strong></td></tr><tr><td><strong>Alloy Steel B8 Class 1</strong></td><td>75</td><td>30</td><td>30</td><td>50</td></tr><tr><td><strong>Alloy Steel B8 Class 2</strong></td><td>Up to 3/4</td><td>125</td><td>12</td><td>35</td></tr></tbody>
                        </table>
                        </div><br />
                        
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel B8 Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
                <thead>
                <tr>
            ...
            <h2 className="mb-4 mt-4 font-bold text-2xl">Dimensions Of Alloy Steel B8 Fasteners</h2> 
            <div className="overflow-x-auto">
            <table>
                <thead>
              <tr>
...
export default AlloySteelB8Fasteners
