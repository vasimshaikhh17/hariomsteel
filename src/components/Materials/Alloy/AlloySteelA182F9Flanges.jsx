      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Ready Stock Of Chrome Moly F9 Flanges, Alloy Steel F9 SORF Flanges, CrMo F9 Long Weld Neck Flanges, Manufacturer of ASTM A182 Cr-Mo F9 Lap Joint Flanges, Alloy Steel F9 Threaded Flanges.        </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is Supplier of AS ASTM A182 F9 Flanges, whichhave a very well-organized efficiency and a lengthy life span. We provide these Alloy Steel ASME SA182 F9 Reducing Flanges in a variety of high-quality materials that are primarily used for boiler, heat-exchanger, general service, and food-industry applications. As the name implies, it is frequently used in the production of boilers and containers for low-pressure uses. They are, however, used in a variety of common construction and industrial uses. We understand the critical end-use uses and adhere to the most stringent manufacturing processes and standards required for this steel to satisfy the exact specs required for condensers, boilers, and heat exchangers. They are examined by quality experts to ensure that they provide perfection.             </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F9 Flanges Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F9 Flanges Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        ...
                        <tr>
                        <td><strong>Alloy Steel F9</strong></td>
                        <td>&nbsp;0.15 max</td>
                        <td>&nbsp;0.3-0.6</td>
                        <td>0.5-1.0</td>
                        <td>&nbsp;0.03</td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F9 Flanges Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table>
                        <tbody>
                        <tr className="bg-primary text-white">
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of Alloy Steel F9 Flanges</h2> 
            <div className="overflow-x-auto">
            <table>
                <tbody>
...
export default AlloySteelA182F9Flanges
