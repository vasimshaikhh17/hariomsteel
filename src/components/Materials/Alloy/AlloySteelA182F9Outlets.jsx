      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            Alloy Steel A182 Outlet, Manufacturer of ASTM A182 AS F9 Flexolet, Alloy Steel F9 Flexible Outlet, Ready Stock Of AS F9 Threadolet, F9 Alloy Steel Threading Outlet.
          </h1>
            ...
            <div className="mb-6">
              ...
              Hariom Steel is an acknowledged stockist and seller of AS ASTM A182 F9 Outlets, which are available in a variety of quality-oriented characteristics.  </p>
              ...
              <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel A182 F9 Outlets Specifications</h2>
                                <div className="overflow-x-auto">
                                <table className="table table-striped table-bordered">
                                <tbody>                    
                                <tr>
                                <th>AS F9 Outlet Fittings Standard</th>
                                <td>ASTM A182  / ASME SA182</td>
                                </tr>
                                <tr>
                                <th>Alloy Steel F9 Outlet Fittings Dimensions</th>
                                <td>ASME / ANSI B16.11, MSS-SP-97, MSS-SP-79, JIS B2316, BS 3799 etc</td>
                                </tr>
                                <tr>
                                <th>F9 Alloy Steel Outlet Fittings Size</th>
                                <td>1/8″-4″ (DN6-DN100)</td>
                                </tr>
                                <tr>
                                <th>F9 Alloy Steel Outlet Fittings Connect Type</th>
                                <td>Welded, threaded, BW, SW</td>
                                </tr>
                                <tr>
                                <th>F9 Alloy Steel Outlet Pipe Diameter</th>
                                <td>DN15 ~ DN40</td>
                                </tr>
                                <tr>
                                <th>AS F9 Outlet Fittings</th>
                                <td>2000 LBS, 3000 LBS, 6000 LBS, 9000 LBS</td>
                                </tr>
                                <tr>
                                <th>Alloy Steel F9 Outlet Process</th>
                                <td>Free forging, plate cutting, forged</td>
                                </tr>
                                <tr>
                                <th>Origin of F9 Alloy Steel Outlet</th>
                                <td>Indian Origin, European Origin, Japanese Origin</td>
                                </tr>
                                <tr>
                                <th>AS F9 Outlet Fittings Packing</th>
                                ...
                                AS F9 Outlet Fittings Chemical Reports<br />
                                EN 10204 3.1<br />
                                Mechanical Reports,<br />
                                Destructive Test Report<br />
                                Non Destructive Test Reports<br />
                                AS F9 Outlet Fittings PMI Test Reports<br />
                                F9 Alloy Steel Outlet Fittings Visual Inspection Reports<br />
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel A182 F9 Outlets Chemical Composition</h2>
                        <div className="overflow-x-auto">
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">F9 Alloy Steel Outlets Mechanical Properties</h2>
                        <div className="overflow-x-auto">
                        <table width="100%" cellspacing="0" cellpadding="0" border="1">
                            <tbody>
                                <tr className="bg-primary text-white">
                                    <td><strong>Grade</strong><p></p>
                                    </td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Alloy Steel F9 Outlets Weldolet Dimensions</h2> 
            <div className="overflow-x-auto">
            <table>
            <tbody>
            <tr className="bg-primary text-white">
...
export default AlloySteelA182F9Outlets
