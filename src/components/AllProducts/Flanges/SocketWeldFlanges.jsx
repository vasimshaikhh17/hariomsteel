          ...
          <div className="text-fontDefault p-4 prod">
            <div className="customContainer text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
              <div className="lg:w-3/4 lg:pr-6">
                ...
                <div className="mb-6">
                  <p className="mb-2">
                  Hariom Steels is a distinguished supplier of Socket Weld Pipe Flanges, which is a type of austenitic steel with intermediate to high corrosion protection. Alloy 20 Socket Weld Flanges is a high alloyed, acid-proof steel that has been created to withstand corrosion in dilute sulphuric acid. This is super austenitic steel with intermediate to high corrosion protection in a variety of industrial environments. It is high-alloy austenitic steel designed for use in the process sector under extreme corrosion circumstances. It is austenitic steel designed for use under extreme corrosion conditions, with excellent resilience to acidic assaults such as sulphuric, phosphoric, and acetic acid. This is an austenitic steel standard with intermediate to high corrosion resistance, and its high alloy makeup provides excellent resistance to pitting and corrosion in a variety of settings.
                  </p>
                </div>
                ...
                <table>
                                ...
                                <tr>
                                  ...
                                  <td><p>ASME DIN, GOST, JIS, UNI, BS, AS2129, AWWA, EN, SABS, NFE etc.<br />

                                    ANSI B16.5 Class 150 Socket Weld-Neck Flanges: -BS Flange, EN Flange, API 6A Flanges, ASME Flanges, ASME Flanges, DIN Flanges, EN1092-1 Flanges, UNI Flanges, JIS/ KS Flanges, BS4504 Flanges, GB Flanges, AWWA C207 Flanges, GOST Flanges, PSI Flangse</p>
                                      ...
                                      <ul> 
                                        ...
                                        <li>ASME B16.5, ASME B16.47 Series A &amp; B, MSS SP44, ASA, API-605, AWWA, Custom Drawings</li>

                                        <li>ASME : ASME B16.5, ASME B16.47(API605), MSS SP44, ASME B16.36, ASME B16.48</li>

                                        <li>ASME B16.5, ASME B16.47, MSS SP44, ASME B16.36, ASME B16.48</li>
                                        ...
                                        <li>DIN: DIN 2527, DIN 2566, DIN 2573, DIN 2576, DIN 2641, DIN 2642, DIN 2655, DIN 2656, DIN 2627, DIN 2628, DIN 2629, DIN  2631, DIN 2632, DIN 2633, DIN 2634, DIN 2635, DIN 2636, DIN 2637, DIN 2638 ANSI B16.5 Class 150 Socket Weld-Neck Flanges</li>
                ...
                <h3 className="text-xl font-semibold mb-4">
                  {" "}
                  Material Grades of Socket Weld Flanges
                </h3>
            ...
            <tbody>
                  ...
                  <td ><strong> Stainless Steel Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Carbon Steel Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Alloy Steel Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Titanium Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Copper Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Copper Nickel Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Inconel Socket Weld-Neck Flanges</strong></td>

                  <td>ASTM B564 / ASME SB564, Inconel 600, 601, 625, 718, 783, 690, x750 ANSI B16.5 Class 150 Socket Weld-Neck Flanges</td>

                  </tr>

                  <tr>

                  <td><strong>Hastelloy Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Monel Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Alloy 20 Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Aluminium Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Nickel Alloy Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Duplex Steel Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Super Duplex Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Incoloy Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>254 SMO Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Nimonic Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Brass Socket Weld-Neck Flanges</strong></td>
                  ...
                  <td><strong>Other Socket Weld-Neck Flanges material</strong></td>
                ...
                <h2 className="text-2xl font-bold mb-4">
                  Socket Weld Flanges Dimensions Chart:
                </h2>
  
                {/* <img src={socketWeldFlanges} alt="" /> */}
                <br />
                ...
                <table>
                            ...
                            <td className="bg-primary text-white" colSpan="11"><strong>ANSI/ASME/ASA B16.5 150lb/sq.in. Flanges</strong></td>
                            ...
                            <td colSpan="11" className="bg-primary text-white"><strong>ANSI/ASME/ASA B16.5 600lb/sq.in. Flanges</strong></td>
                ...
                <div className="mb-8">
  <h3 className="text-xl font-semibold mb-4">
    Socket Weld Flanges Applications:
  </h3>
  <ul className="list-disc list-inside">
    <li>High-pressure and small diameter piping systems</li>
    <li>Used in systems requiring exceptional leakage prevention</li>
    <li>Ideal for hazardous and toxic fluid handling</li>
    <li>Commonly used in steam, oil, and gas pipelines</li>
    <li>Utilized in the chemical, petrochemical, and power generation industries</li>
    <li>Excellent for applications requiring strong and durable welded joints</li>
  </ul>
</div>
