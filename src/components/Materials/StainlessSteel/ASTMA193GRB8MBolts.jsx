      ...
      <div className="text-fontDefault p-4 prod">
        <div className="customContainer  text-fontDefault p-6 shadow-md rounded-md flex flex-col lg:flex-row">
          <div className="lg:w-3/4 lg:pr-2">
            ...
            STAINLESS STEEL ASTM A193 B8M HIGH TEMPERATURE FASTENERS, MANUFACTURER OF ASTM A193 B8M THREADED ROD, SS ASTM A193 B8M SOCKET HEAD CAP SCREW, READY STOCK OF SS ASTM A193 B8M ALLEN CAP BOLT, ASTM A193 B8M HEX BOLT SUPPLIER
            </h1>
{/* 
            ...
            <div className="mb-6">
              ...
              Hariom Steel is a recognized seller and stockist of ASTM A193 Grade B8M Bolts, available in a variety of sizes, dimensions, and shapes. We are a major company dedicated to offering a broad range of ASME SA193 GR.B8M Hex Bolts, processed according to market standards using high-quality steel and other materials, combined with cutting-edge technology. These bolts are manufactured using advanced technology and are shaped with precision using power tools and dies. They exhibit exceptional strength and resilience at cryogenic temperatures and have a higher chromium concentration and lower carbon content compared to other steel types. Additionally, they resist atmospheric corrosion as well as mildly oxidizing and reducing conditions.
              </p>
              ...
              <div className="mt-5 mb-5  flex items-center justify-center">
                ...
                {/* specification */}
                <h2 className="mb-4 mt-4 font-bold text-2xl">ASTM A193 GR.B8M Bolts Fasteners Specifications</h2>
                                ...
                                <h2 className="mb-4 mt-4 font-bold text-2xl">ASTM A193 GR.B8M Bolts Chemical Composition</h2>
                        <div>
                        <table>
                        <tbody>
                        ...
                        <tr>
                          <td><strong>ASTM A193 B8M</strong></td>
                          <td>0.08 max.</td>
                          <td>2.00 max</td>
                          <td>1.0 max</td>
                          <td>0.045 max</td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">ASTM A193 GR.B8M Bolts Mechanical Properties</h2>
                        <div className='overflow-x-auto'>
                        <table>
                        <thead>
                        <tr><th><strong>Tensile Strength</strong></th><th><strong>Yield Strength</strong></th><th><strong>Elongation</strong></th><th><strong>Reduction area</strong></th><th><strong>Brinell Hardness</strong></th></tr></thead><tbody><tr><td>52.75kg/MM2</td><td>21.1kg/MM2min</td><td>30% min</td><td>50% min</td><td>223 B.H.N max.</td></tr>
                      </tbody>
                        </table>
                        </div><br />

                        <h2 className="mb-4 mt-4 font-bold text-2xl">ASTM A193 GR.B8M Bolts Standard</h2>
                        <div className='overflow-x-auto'>
                        <table>
                        <tbody>
                            <tr className='bg-primary text-white'>
                        <td><strong>Hexagon Bolt / Set Screws</strong></td>
                        <td><strong>Stud Bolt</strong></td>
                        <td><strong>Hexagon Nuts</strong></td>
                        <td><strong>Socket Cap screws</strong></td>
                        </tr>
                            <tr>
                        <td>DIN 931</td>
                        <td>BS4882</td>
                        ...
                        <tbody>
                        <tr className='bg-primary text-white'>
                    <td><strong>Socket &amp; Slotted Set Screws</strong></td>
                    <td><strong>Socket &amp; Slotted Countersunk Screws</strong></td>
                    <td><strong>Studs</strong></td>
                    <td><strong>Washers</strong></td>
                    </tr>
                        <tr>
                    <td>DIN 913</td>
                    <td>DIN 963</td>
                    ...
                    <td>DIN 9021</td>
                        ...
                        <h2 className="mb-4 mt-4 font-bold text-2xl">Weight Chart Of ASTM A193 GR.B8M Bolts</h2> 
                        <div className='overflow-x-auto'>
            <table>
                <thead>
                <tr>
            ...
            <h2 className="mb-4 mt-4 font-bold text-2xl">Dimensions Of ASTM A193 B8M Bolts</h2> 
            <div className='overflow-x-auto'>
            <table>
            <thead>
              <tr>
...
export default ASTMA193GRB8MBolts